...
import 'package:mobile_sales_force_automation/presentation/datas/pages/daftar_pelanggan.dart';
        ...
        children: [
          ...
          const Padding(
            ...
            child: Row(
              ...
              children: [Text('Nama Pelanggan'), Icon(Icons.short_text)],
            ),
          ),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Row(children: [Expanded(child: Text('Pelanggan Baru'))]),
              const SizedBox(height: 20),
              // NAMA
              Row(
                children: [

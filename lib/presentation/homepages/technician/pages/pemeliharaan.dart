...
import 'package:mobile_sales_force_automation/presentation/homepages/technician/pages/histori_pemeliharaan.dart';

class Pemeliharaan extends StatefulWidget {
  const Pemeliharaan({super.key});

  @override
  State<Pemeliharaan> createState() => _PemeliharaanState();
}
            ...
            child: ElevatedButton(
              ...
              onPressed: (() {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const HistoriPemeliharaan(),
                  ),
                );
              }),
              child: const Text(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Padding(
                ...
                child: Text('Tambah Pemeliharaan Baru'),
              ),

...
import 'package:mobile_sales_force_automation/presentation/homepages/technician/pages/data_analyer.dart';
import 'package:mobile_sales_force_automation/presentation/homepages/technician/pages/kunjungan_technician.dart';
import 'package:mobile_sales_force_automation/presentation/homepages/technician/pages/pemeliharaan.dart';
import 'package:mobile_sales_force_automation/presentation/homepages/technician/pages/perbaikan.dart';
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const KunjunganTechnician(),
                        ),
                      );
                    },
                  ),
                  ...
                  child: MaterialButton(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image.asset('assets/images/perbaikan.png', scale: 6),
                          const SizedBox(height: 10),
                          const Text(
                            'Perbaikan',
                            style: TextStyle(

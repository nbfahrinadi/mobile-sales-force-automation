...
import 'package:mobile_wg/homepages/reporting/detail_reporting.dart';
import 'package:mobile_wg/homepages/reporting/tambah_reporting.dart';
          ...
          child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const TambahReporting()),
                );
              },
              child: const Text(
                '+ Tambah',

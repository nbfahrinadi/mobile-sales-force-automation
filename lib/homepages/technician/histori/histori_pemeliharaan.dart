...
class HistoriPemeliharaan extends StatefulWidget {
  const HistoriPemeliharaan({super.key});

  @override
  State<HistoriPemeliharaan> createState() => _HistoriPemeliharaanState();
}

class _HistoriPemeliharaanState extends State<HistoriPemeliharaan> {
  // final _dataAnalyzer = ;
